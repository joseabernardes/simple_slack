...
public final class AvailablePortFinder {
    ...
    /**
     * We'll hold open the lowest port in this process so parallel processes won't use the same block of ports. They'll go up to the next block.
     */
    ...
    /**
     * Gets the next available port starting at the lowest number. This is the preferred method to use. The port return is immediately marked in use and doesn't
     * rely on the caller actually opening the port.
     *
